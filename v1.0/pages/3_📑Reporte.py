...
def process_logs(logs):
    ...
    df = pd.DataFrame(data, columns=['Nombre', 'Fecha', 'Hora de Salida', 'Hora de Entrada', 'Horas Trabajadas'])
    return df
...
with tab1:
    if st.button('Actualizar Datos'):
        ...
        with st.spinner('Retriving Data from redis DB...'):
            ...
            st.success('Actualizar base de datos')
